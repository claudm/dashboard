    ...
    ecConfig.toolbox = {
        ...
        feature: {
            mark: {
                show: false,
                title: {
                    mark: 'Opção de linha auxiliar',
                    markUndo: 'Retirar guias',
                    markClear: 'Guias vazias'
                },
                lineStyle: {
                    width: 1,
                    color: '#1e90ff',
            ...
            dataZoom: {
                show: false,
                title: {
                    dataZoom: 'Escala Regional',
                    dataZoomReset: 'Regional escalado para trás'
                }
            },
            dataView: {
                show: false,
            ...
            magicType: {
                ...
                title: {
                    ...
                    stack: 'Pilha',
                    tiled: 'Telha',
                    force: 'Switch layout orientada-Force',
                    chord: 'Gráfico Chord',
                    pie: 'pizza',
                    funnel: 'Funil'
                },
